...
public interface GovernancePolicyDAO {
    ...
    String addOrgGovernancePolicy(OrgGovernancePolicy policy) throws GovernancePolicyMgtServerException;

    Optional<OrgGovernancePolicy> getOrgGovernancePolicyById(String policyId)
    ...
    void deleteOrgGovernancePolicyById(String policyId) throws GovernancePolicyMgtServerException;

    // -------------------------------------------------------------------------
    // Resource-level CRUD
    // -------------------------------------------------------------------------

    String addResourceGovernancePolicy(ResourceGovernancePolicy policy) throws GovernancePolicyMgtServerException;

    Optional<ResourceGovernancePolicy> getResourceGovernancePolicyById(String policyId)
            throws GovernancePolicyMgtServerException;
    ...
    void deleteResourceGovernancePolicyById(String policyId) throws GovernancePolicyMgtServerException;
